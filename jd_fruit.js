...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/1277002811/JDbot/master/shareCodes/total/JD_Fruit.json", headers: {
      ...
      try {
        if (err) {
          ...
          $.get({ url: `https://raw.githubusercontent.com/indextank/test_jd/master/backUp/total/JD_Fruit.json`, 'timeout': 10000 }, (err, resp, data) => {
