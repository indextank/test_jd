...
更新时间：2021-2-19（宠汪汪助力更新Token的配置正则表达式已改）
...
//下面给出好友赛跑助力的示例填写规则
let run_pins = ["wdwMJcEGPKgMlq", "niujie678", "hajiuhajiu2733", "wdovJvWPLhUUqC", "jd_51d9ee19241e2", "jd_4a2a4cee61c9e", "jd_441027f2a1e0d", "hajiuhajiu2067"];
...
temp = ["wdwMJcEGPKgMlq", "niujie678", "hajiuhajiu2733", "wdovJvWPLhUUqC", "jd_4a2a4cee61c9e", "jd_441027f2a1e0d", "hajiuhajiu2067"];
run_pins = [temp.join(',')];
// $.LKYLToken = '76fe7794c475c18711e3b47185f114b5' || $.getdata('jdJoyRunToken');
// $.LKYLToken = $.getdata('jdJoyRunToken');
let friendsArr = ["wdwMJcEGPKgMlq", "niujie678", "hajiuhajiu2733", "wdovJvWPLhUUqC", "q2705322732", "wdfxtlDMXHbaHu", "wdaABrvfJIjgOl", "hajiuhajiu2067", "18939824134_p", "jd_441027f2a1e0d", "jd_747fca41dbd0a", "jd_51d9ee19241e2", "wdwMJcEGPKgMlq", "ningbormb", "jd_DcDTMOblJHiM", "jd_553ea3a6ef2f4", "yhr_19820404"];
...
function readToken() {
  return new Promise(resolve => {
    $.get({ url: `https://raw.githubusercontent.com/indextank/test_jd/master/backUp/joytoken.json`, 'timeout': 10000 }, (err, resp, data) => {
      try {
        if (err) {
...
function getFriendPins() {
  return new Promise(resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/hajiuhajiu/code/main/share/friendpin.json",
      headers: {
