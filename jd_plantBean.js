...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: "https://gitee.com/xr2021/share/raw/master/JD_bean.json", headers: {
      ...
      try {
        if (err) {
          ...
          $.get({ url: `https://raw.githubusercontent.com/indextank/test_jd/master/backUp/total/JD_bean.json`, 'timeout': 10000 }, (err, resp, data) => {
