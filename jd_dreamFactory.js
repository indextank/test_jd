...
async function joinLeaderTuan() {
  let res = await updateTuanIdsCDN(), res2 = await updateTuanIdsCDN("https://raw.githubusercontent.com/indextank/test_jd/master/shareCodes/jd_updateFactoryTuanId.json")
...
function updateTuanIdsCDN(url = 'https://raw.githubusercontent.com/indextank/test_jd/master/shareCodes/jd_updateFactoryTuanId.json') {
  return new Promise(async resolve => {
    $.get({
      url,
      timeout: 200000,
...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({
      url: "https://raw.githubusercontent.com/indextank/test_jd/master/backUp/total/jxfactory.json", headers: {
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }
    }, async (err, resp, data) => {
      try {
...
function requireConfig() {
  return new Promise(async resolve => {
    await updateTuanIdsCDN('https://raw.githubusercontent.com/indextank/test_jd/master/shareCodes/jd_updateFactoryTuanId.json');
